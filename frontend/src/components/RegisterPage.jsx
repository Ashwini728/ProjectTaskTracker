...
const RegisterPage = ({ onRegister }) => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100 bg-light"style={{ backgroundColor: 'transparent' }}>
      <div className="card p-4 shadow-lg" style={{ width: '100%', maxWidth: '400px' ,backgroundColor: 'transparent' }}>
